...
import { AppBar, Toolbar, Drawer, IconButton, Box, Avatar, Chip, useMediaQuery } from '@mui/material';
...
export default function Layout() {
  ...
  return (
    <div className="app-shell">
      ...
      <SettingsDrawer open={settingsOpen} onClose={() => setSettingsOpen(false)} onDownloadTutorial={handleDownloadTutorial} />
